...
var VideoJsStrategy = /** @class */ (function (_super) {
    __extends(VideoJsStrategy, _super);
    function VideoJsStrategy() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    VideoJsStrategy.prototype.initialize = function (videoElementId, streamUrl) {
    ...
    __decorate([
        WithTelemetry
    ], VideoJsStrategy.prototype, "initialize", null);
    return VideoJsStrategy;
}(BasePlayerStrategy));
export { VideoJsStrategy };
